...
namespace Feipder.Tools.Extensions
{
    public static class ServiceExstension
    {
        ...
        public static IServiceCollection ConfigureSwagger(this IServiceCollection services)
        {
            ...
            {
                c.EnableAnnotations();
                c.SwaggerDoc($"v1", new OpenApiInfo { Title = "Feip back", Version = version.ToString(), Description = "admin: 88005553535 | guest: 88005553536 . Код подтверждения всегда 0000" });
